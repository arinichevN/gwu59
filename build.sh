...
function build {
	...
	build_lib $1 && \
	cd ../ 
	gcc -D_REENTRANT $1 $3 $PLATFORM $INI_MODE main.c -o $2 -lpthread -L./lib -lpac && echo "Application successfully compiled. Launch command: sudo ./"$2
}
