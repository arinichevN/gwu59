...
function build_lib {
	...
	gcc $1 $PLATFORM -c serial.c $DEBUG_PARAM && \
	...
	rm -f libpac.a
	ar -crv libpac.a app.o crc.o timef.o udp.o util.o serial.o acp/main.o && echo "library: done"
	rm -f *.o acp/*.o
}
...
function build {
	...
	build_lib $1 && \
	cd ../ 
	gcc -D_REENTRANT $1 $3 $PLATFORM $INI_MODE main.c -o $2 $DEBUG_PARAM -lpthread -L./lib -lpac && echo "Application successfully compiled. Launch command: sudo ./"$2
}
